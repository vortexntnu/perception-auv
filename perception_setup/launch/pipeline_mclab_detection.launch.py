    ...
    composable_node_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                name='image_filtering_white_balance_node',
                parameters=[
                    filtering_params_file,
                    {
            ...
            ComposableNode(
                package='image_filtering',
                plugin='ImageFilteringNode',
                name='image_filtering_otsu_node',
                parameters=[
                    filtering_params_file,
                    {'filter_params.filter_type': 'otsu'},
                ],
                extra_arguments=[{'use_intra_process_comms': True}],
                condition=IfCondition(enable_filtering),
                remappings=[
                    ('/downwards_camera/image_raw', '/image_filtering/white_balance'),
                    # ('/filtered_image', '/image_filtering/otsu'),
                ],
            ),
            ComposableNode(
