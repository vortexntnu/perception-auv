...
DEFAULT_CONTAINER_NAME = 'unet_container'
...
def generate_launch_description():
    ...
    object_name = DeclareLaunchArgument(
        ...
        description='The object class that the network is detecting')
    ...
    unet_encoder_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'network_image_width': LaunchConfiguration('network_image_width'),
            'network_image_height': LaunchConfiguration('network_image_height'),
            'image_mean': LaunchConfiguration('encoder_image_mean'),
            'image_stddev': LaunchConfiguration('encoder_image_stddev'),
            'enable_padding': 'True',
            'use_planar_input': LaunchConfiguration('use_planar_input'),
