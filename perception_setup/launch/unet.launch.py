...
def generate_launch_description():
    ...
    interleaved_to_planar_node = ComposableNode(
        ...
        parameters=[
            {
                'input_tensor_shape': [LaunchConfiguration('network_image_height'),
                                       LaunchConfiguration('network_image_width'), 3],
                'num_blocks': 40,
            }
        ],
        remappings=[
    ...
    reshape_node = ComposableNode(
        ...
        parameters=[
            {
                'input_tensor_shape': [3, LaunchConfiguration('network_image_height'),
                                       LaunchConfiguration('network_image_width')],
                'output_tensor_shape': [1, 3, LaunchConfiguration('network_image_height'),
                                        LaunchConfiguration('network_image_width')],
