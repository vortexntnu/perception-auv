...
def generate_launch_description():
    ...
    model_file_path = DeclareLaunchArgument(
        'model_file_path',
        default_value=os.path.join(get_package_share_directory('perception_setup'), 'models', 'best200.onnx'),
        description='Path to the ONNX model file'
    )
    engine_file_path = DeclareLaunchArgument(
        'engine_file_path',
        default_value=os.path.join(get_package_share_directory('perception_setup'), 'models', 'best200.engine'),
    ...
    return LaunchDescription([
        ...
        ComposableNodeContainer(
            ...
            composable_node_descriptions=[tensor_rt_node, yolov8_decoder_node, image_format_converter_node_left, zed_wrapper_component],
            output='screen',
